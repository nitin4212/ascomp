(function ($, DX, undefined) {
    ...
    DX.framework.html.SlideOutController = DX.framework.html.DefaultLayoutController.inherit({
        ...
        _createNavigation: function (navigationCommands) {
            ...
            iDiv.id = 'btnContainer';
            //iDiv.style = "background-color:blue;color:white;font-size:15px;font-weight:bold;height:20pt;";
            iDiv.innerHTML = "Welcome Guest";
            this.$slideOut.find(".dx-slideout-menu").prepend(iDiv);
        ...
        _onViewShown: function (viewInfo) {
            ...
            //R3MobileApp.data.Customer = localStorage.getItem("R3CustomerName");
